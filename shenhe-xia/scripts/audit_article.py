...
# humanize-guide 为上游源，本清单随其增删做联动校验（避免两处漂移）。
# 脚本仅做关键词命中兜底，真实判定由 LLM 语义复核(主路径)完成。
AI_TRACE_PHRASES = [
    # —— 与 humanize-guide 词汇层对齐（Layer-1 套路词）——
    "首先", "其次", "最后", "综上所述", "值得注意的是", "重要的一点",
    "在当今社会", "随着社会的不断发展", "背景下", "在这个充满挑战的时代",
    "众所周知", "不难看出", "显而易见", "不可忽视", "不可否认", "毋庸置疑",
    "总而言之", "总的来说",
    "此外", "与此同时", "近年来",
    "我们将", "让我们", "旨在", "致力于", "赋能", "抓手", "闭环",
    "不仅", "一方面", "另一方面",
]
